    ...
    let 
        ...
        quantityPicker = {
            ...
            init: function() {
                ...
                $(document).on("change", quantityFieldSelector, quantityPicker.onFieldChange);
            }
        };
        ...
        let lineItem = {
            ...
            init: function() {
                $(document).on('click', removeLineSelector, lineItem
                .onLineRemoved);
                $(document).on('change', lineQuantitySelector, lineItem
